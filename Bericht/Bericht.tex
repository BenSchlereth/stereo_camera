...
return blur, mask
	...
	For the cone $6m$ apart the absolute error is already more important then the the error occured due to the rotation. Nevertheless the relative distance with $\Delta_s = 0,30m$ and $\Delta_h = 0,36m$ is still a little bit better.
	...
	%picture
	As seen in figure ??? the computer visualize a green area but does not detect as a valid cone.
