...
\begin{document}
	...
	To find the cones inside a picture one could create a dataset of 100+ cones and then train a neural network.
	For this application it is not necessary to detect different objects so it is also possible to describe the features of a cone and search for them inside a picture.
